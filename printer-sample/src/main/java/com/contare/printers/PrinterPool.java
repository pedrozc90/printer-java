...
import com.contare.printers.sato.driver.SatoPrinter;
...
public class PrinterPool {
    ...
    public Printer factory(final String type, final String ip, final Integer port) {
        final String _type = Objects.requireNonNull(type, "type must not be null");
        switch (_type) {
            case "SATO":
            ...
            default:
                throw new IllegalArgumentException("Printer type " + _type + " is not supported");
        }
    }
